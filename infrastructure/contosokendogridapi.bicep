...
resource kendoBslService 'Microsoft.App/containerApps@2026-01-01' existing = {
  ...
  properties: {
    ...
    template: {
      containers: [
        {
          name: 'kendo-api'
          image: '${acr.properties.loginServer}/${prefix}kendogridapi:${imageTag}'
          resources: {
            cpu: json(cpuCore)
          ...
          env: [
            ...
            {
              name: 'baseBslUrl'
              value: 'https://${kendoBslService.properties.configuration.ingress.fqdn}/'
            }
          ]
        }
      ]
